...
import ast
import json
from ssoc_autocoder.sagemaker_get_embeddings_model_training import HierarchicalSSOCClassifier_V2pt2
from ssoc_autocoder.sagemaker_get_embeddings_model_prediction import model_predict
...
def predict_fn(input_data, model):
    ...
    preds = model_predict(auto_model, tokenizer, encoding_path, title, text)
